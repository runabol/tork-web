            ...
            <div>
              ...
              <form>
                <input
                  ...
                  className="block my-2 w-full rounded-md border-0 py-1.5 px-2 shadow-xs ring-1 ring-inset bg-white dark:bg-background ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6"
